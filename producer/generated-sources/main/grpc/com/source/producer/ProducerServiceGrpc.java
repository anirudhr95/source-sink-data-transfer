...
public final class ProducerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.source.producer.ProducerRequest,
      com.source.producer.ProducerResponse> getGetItemMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getItem",
      requestType = com.source.producer.ProducerRequest.class,
      responseType = com.source.producer.ProducerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.source.producer.ProducerRequest,
      com.source.producer.ProducerResponse> getGetItemMethod() {
    io.grpc.MethodDescriptor<com.source.producer.ProducerRequest, com.source.producer.ProducerResponse> getGetItemMethod;
      ...
      synchronized (ProducerServiceGrpc.class) {
        if ((getGetItemMethod = ProducerServiceGrpc.getGetItemMethod) == null) {
          ProducerServiceGrpc.getGetItemMethod = getGetItemMethod =
              io.grpc.MethodDescriptor.<com.source.producer.ProducerRequest, com.source.producer.ProducerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getItem"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.source.producer.ProducerRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.source.producer.ProducerResponse.getDefaultInstance()))
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.source.producer.ProducerRequest,
                com.source.producer.ProducerResponse>(
  ...
  public static final class ProducerServiceBlockingStub extends io.grpc.stub.AbstractStub<ProducerServiceBlockingStub> {
    ...
    /**
     */
    public com.source.producer.ProducerResponse getItem(com.source.producer.ProducerRequest request) {
  ...
  public static final class ProducerServiceFutureStub extends io.grpc.stub.AbstractStub<ProducerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.source.producer.ProducerResponse> getItem(
        com.source.producer.ProducerRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ITEM:
          serviceImpl.getItem((com.source.producer.ProducerRequest) request,
              (io.grpc.stub.StreamObserver<com.source.producer.ProducerResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProducerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.source.producer.Producer.getDescriptor();
    }
