...
public final class ProducerServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.sourcesink.consumer.ProducerRequest,
      com.sourcesink.consumer.ProducerResponse> getGetItemMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getItem",
      requestType = com.sourcesink.consumer.ProducerRequest.class,
      responseType = com.sourcesink.consumer.ProducerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.sourcesink.consumer.ProducerRequest,
      com.sourcesink.consumer.ProducerResponse> getGetItemMethod() {
    io.grpc.MethodDescriptor<com.sourcesink.consumer.ProducerRequest, com.sourcesink.consumer.ProducerResponse> getGetItemMethod;
      ...
      synchronized (ProducerServiceGrpc.class) {
        if ((getGetItemMethod = ProducerServiceGrpc.getGetItemMethod) == null) {
          ProducerServiceGrpc.getGetItemMethod = getGetItemMethod =
              io.grpc.MethodDescriptor.<com.sourcesink.consumer.ProducerRequest, com.sourcesink.consumer.ProducerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getItem"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sourcesink.consumer.ProducerRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.sourcesink.consumer.ProducerResponse.getDefaultInstance()))
  ...
  public static abstract class ProducerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getItem(com.sourcesink.consumer.ProducerRequest request,
        io.grpc.stub.StreamObserver<com.sourcesink.consumer.ProducerResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.sourcesink.consumer.ProducerRequest,
                com.sourcesink.consumer.ProducerResponse>(
  ...
  public static final class ProducerServiceBlockingStub extends io.grpc.stub.AbstractStub<ProducerServiceBlockingStub> {
    ...
    /**
     */
    public com.sourcesink.consumer.ProducerResponse getItem(com.sourcesink.consumer.ProducerRequest request) {
  ...
  public static final class ProducerServiceFutureStub extends io.grpc.stub.AbstractStub<ProducerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.sourcesink.consumer.ProducerResponse> getItem(
        com.sourcesink.consumer.ProducerRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ITEM:
          serviceImpl.getItem((com.sourcesink.consumer.ProducerRequest) request,
              (io.grpc.stub.StreamObserver<com.sourcesink.consumer.ProducerResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProducerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.sourcesink.consumer.Consumer.getDescriptor();
    }
